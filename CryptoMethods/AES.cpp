...
inline void mixcolumns(uint8_t* state)
{
	...
	{
		tmp[0] = gmult(2, state[4 * i]) ^ gmult(3, state[4 * i + 1]) ^ gmult(1, state[4 * i + 2]) ^ gmult(1, state[4 * i + 3]);
		tmp[1] = gmult(1, state[4 * i]) ^ gmult(2, state[4 * i + 1]) ^ gmult(3, state[4 * i + 2]) ^ gmult(1, state[4 * i + 3]);
		tmp[2] = gmult(1, state[4 * i]) ^ gmult(1, state[4 * i + 1]) ^ gmult(2, state[4 * i + 2]) ^ gmult(3, state[4 * i + 3]);
		tmp[3] = gmult(3, state[4 * i]) ^ gmult(1, state[4 * i + 1]) ^ gmult(1, state[4 * i + 2]) ^ gmult(2, state[4 * i + 3]);
		state[4 * i] = tmp[0];
		state[4 * i + 1] = tmp[1];
		state[4 * i + 2] = tmp[2];
		state[4 * i + 3] = tmp[3];
...
inline void rmixcolumns(uint8_t* state)
{
	...
	for (size_t i = 0; i < 4; ++i)
	{
		tmp[0] = gmult(14, state[4 * i]) ^ gmult(11, state[4 * i + 1]) ^ gmult(13, state[4 * i + 2]) ^ gmult(9, state[4 * i + 3]);
		tmp[1] = gmult(9, state[4 * i]) ^ gmult(14, state[4 * i + 1]) ^ gmult(11, state[4 * i + 2]) ^ gmult(13, state[4 * i + 3]);
		tmp[2] = gmult(13, state[4 * i]) ^ gmult(9, state[4 * i + 1]) ^ gmult(14, state[4 * i + 2]) ^ gmult(11, state[4 * i + 3]);
		tmp[3] = gmult(11, state[4 * i]) ^ gmult(13, state[4 * i + 1]) ^ gmult(9, state[4 * i + 2]) ^ gmult(14, state[4 * i + 3]);
		state[4 * i] = tmp[0];
		state[4 * i + 1] = tmp[1];
		state[4 * i + 2] = tmp[2];
		state[4 * i + 3] = tmp[3];
...
bool AES::KeyExpand()
{
	...
	{
		uint8_t temp[4] = { p_roundkey[(i - 1) << 2],p_roundkey[((i - 1) << 2) + 1],
